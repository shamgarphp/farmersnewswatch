...
<section id="main">
    <section class="home-section">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-8 " style="border:0px solid red;">
                   ...
                   <?php
                    ...
                    <div class="ad">
                       <a href="<?php echo($row_p['url']); ?>"  target="_blank">
                        <img src="Administrator/Admin_Promotions/<?php echo($row_p['file_content']); ?>" style="width: 300px; height: 250px;">
                        </a>
                    </div>
					<?php
                	}
