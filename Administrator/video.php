...
&& in_array($extension, $allowedExts)) {
  if ($_FILES["i_upload"]["error"] > 0) {
   ...
   //   echo $pan_proof_imagename;
    if (file_exists("News_Uploads/videonews/" . $_FILES["i_upload"]["name"])) {
        $incre="1";
      $rn= $_FILES["i_upload"]["name"];
      $dyna=$incre.$rn;
      //echo $rrn;

      if(file_exists("News_Uploads/videonews/" . $dyna))
          {
      ...
      move_uploaded_file($_FILES["i_upload"]["tmp_name"],
      "News_Uploads/videonews/" . $_FILES["i_upload"]["name"]);
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Add Video news</div>
	...
	<a href="news_videoreports.php" style="color:white;">View Video reports </a></span>
	</div>
