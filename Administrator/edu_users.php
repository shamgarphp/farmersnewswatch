...
<script type="text/javascript">
	...
	$("#minus_gallery").click(function(){
       //alert('gfg');
		 $("#minus_gallery").hide();
		 $("#plus_gallery").show();
		 
		 $("#data_user_gallery").hide(1300);
...
<input type="hidden" name="edu12" id="gt"/>
	...
	<div class="form-group">
      ...
      <input type="text" class="form-control" name="url" id="pac-input"    placeholder="WebSite Url EX: http://www.google.com"   title="Please Enter Website Address"  />
</div>
	</div>	
	...
	<div class="col-sm-10" style="border:0px solid grey;">
	<div class="form-group">
      <textarea class="form-control" name="about" style="height:150px;"  placeholder="About Us"  title="Please Enter About us of your institution" required ></textarea>
	</div>
	</div>	
...
<!--
  ...
  <input type="email" class="form-control" name="or6"  placeholder="Contact Person Mail ID"  title="Please enter proper mail id" required>
	...
	<div class="col-sm-12" id="data_user3"  style="padding:0px;margin-bottom:20px;" >
...
<!--
	...
	<div class="col-sm-12" style="text-shadow:0px 0px 10px white;font-size:14px;"> Institution Sliders and About Us

	<a href="javascript:void()">
	<span  class="glyphicon glyphicon-plus" style="float:right;display:none;" id="plus_gallery"></span>
	</a>
	<a href="javascript:void()">
	<span class="glyphicon glyphicon-minus" style="float:right;" id="minus_gallery"></span>
	</a>
	</div>
	</div>
	
	
	<div class="col-sm-12" id="data_user_gallery"  style="padding:0px;margin-bottom:50px;border:1px solid lightgrey;background-color:#f8f8f8;" >
	...
	<div class="form-group">
Institution Image:
      <input type="file" class="form-control"  name="edu14"    title="Institution Image">
	</div>
	</div>	
	<div class="col-sm-5" style="border:0px solid grey;">
	<div class="form-group">
	...
	Slider 1:
      <input type="file" class="form-control"  name="edu15"   title="Slider 1">
	...
	<div class="form-group">
    Slider 2:
      <input type="file" class="form-control"  name="edu16"   title="Slider 2">
	</div>
	</div>	
	<div class="col-sm-5" style="border:0px solid grey;">
	<div class="form-group">
    ...
    Slider 3:
      <input type="file" class="form-control"  name="edu17"   title="Slider 3">
	</div>
	</div>
	<div class="col-sm-1" style="border:0px solid grey;">   </div>
	</div>
	...
	<input type="submit" name="useradd" class="btn btn-primary" value="Submit" style="width:100px;font-weight:bold;" />
</div>
	<div class="col-sm-5" style=""></div>
	</div>
	
	<div class="col-sm-12" style="padding:30px;"></div>
...
//
$institut="";
$institut_columns="website,image,image1,image2,image3,aboutus,datee,timee,dayy,monthh,yearr,mgmt_code,education_type,institution_name,institution_code,established_year,country,state,city,village,pincode,google_maplink,latitude,langitude,institution_logo,status";
$tablea="edu_user_institution";
	...
	/*
	$institut="";
	$institut_columns="datee,timee,dayy,monthh,yearr,mgmt_code,education_type,institution_name,institution_code,established_year,country,state,city,village,pincode,google_maplink,latitude,langitude,institution_logo,status";
	$tablea="edu_user_institution";
...
$colvala="'".$_POST['url']."','".$inst_image."','".$slider1."','".$slider2."','".$slider3."','".$about1."','".$date."','".$time."','".$day."','".$month."','".$year."','".$mgmt_code."',$institut,'$pan_proof_imagename4','1'";
	
	
	//echo($tablea." ".$institut_columns." ".$colvala);
  ...
  if($ins1 && $ins2 && $ins3 && $ins4)
  {
	...
	<tr bgcolor='#FFFFFF' height='30'> 
		...
		<p>Thank you for register with us. Please find out your credentials below here.</p>
			...
			<b>PassWord : </b>$pass
			<br/><br/>
			Now you can use our services. <a href='http://www.bslate.co.in/management' style='background-color:tomato;color:white;'>Click here</a> to login
			<br /><br /><br />
			<b>Regards</b><br/>
