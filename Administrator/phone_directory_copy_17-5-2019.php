...
// }
	...
	$columns="category,con_name,number,city_id";
	...
	// $column_values="'".$_POST['category']."','".$date."','".$time."','".$day."','".$month."','".$year."','".$i_title."','".$name."','".$number."','".$city_id."','".$i_edit."','".$filetype."','".$dyna."','1','".$post_code."','".$st."','".$_SESSION['head']."'";
	$column_values="'".$category."','".$name."','".$number."','".$city_id."'";
	    ...
	    <div class="page-container" style="min-height:567px">
			...
			<?php  require_once("includes/leftsidemenu.php");  ?>
	            ...
	            <div class="content-wrapper">
					...
					<a href="phone_directoryreports.php" style="color:white;">View Content reports </a></span>
					</div>
