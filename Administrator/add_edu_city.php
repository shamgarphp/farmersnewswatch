...
<div class="content" style="padding:0px;">
	...
	<div class="col-sm-12" id="edu_type_label"> Add City</div>
	...
	<div class="form-group">
      ...
      <select class="form-control" id="usr" name="Countryname" onchange="getstates(this.value)" placeholder="Country Name" pattern="[a-zA-Z]{3,30}" title="Please Enter Country Name" required>
	...
	<div class="form-group">
      ...
      <select class="form-control" id="usr_state" name="sname" placeholder="State Name" pattern="[a-zA-Z+ ]{3,30}" title="Please Enter State Code" required>
	...
	<div class="form-group">
      ...
      <input type="text" class="form-control" id="usr" name="cname" placeholder="City Name" pattern="[a-zA-Z+ ]{3,30}" title="Please Enter City Name" required>
