...
<div class="content" style="padding:0px;">
	...
	<div class="col-sm-4" id="edu_type_label" style="padding:10px;"><a href="#" style="text-decoration:none;"> View State</a></div>
	<div class="col-sm-1" id="edu_type_label"></div>
	<div class="col-sm-3" id="edu_type_label" style="padding:10px;"><a href="#" style="text-decoration:none;text-align:right;"> Export StateList</a></div>
	<div class="col-sm-2" id="edu_type_label"></div>
	<div class="col-sm-2" id="edu_type_label" style="padding:10px;"><a href="add_edu_state.php" style="text-decoration:none;text-align:right;"> Add State</a></div>
 ...
 while ($row = mysql_fetch_array($query))
    {
		?>
           <tr style="border-bottom:1px solid lightgrey;">
			   ...
			   <td><a href="view_edu_state.php?edit=<?php echo $row['SNO'];?>"><span class="glyphicon glyphicon-pencil" data-toggle="modal" role="dialog" data-target="#myModal"></span></a></td>
		   </tr>
			   <?php
	}
                ?>
...
<input type="hidden" value="<?php echo($count)?>" name="hidea">-->
    ...
    if(isset($_POST['delete']))
	{
        ...
        $que = "DELETE FROM state WHERE SNO='$qwerty'";
        $exe = mysql_query($que);
 ...
 echo"
	...
	window.location.href='view_edu_state.php';
	</script>
	";
	exit;
	}
...
$sql2="select * from state where SNO='".$edit1."'";
...
<form action="view_edu_state.php" method="POST" >
	 ...
	 if(isset($_POST['update']))
{
	...
	$var="UPDATE state SET Countryname='".$val1."',Countrycode='".$val2."' WHERE SNO='".$serial."'";
    $res=mysql_query($var);
	if($res)
	{
