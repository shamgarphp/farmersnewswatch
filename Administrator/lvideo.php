...
$post_code=strtotime($asd);
	...
	$columns="created_date,created_time,created_day,created_month,created_year,news_title,state_city,content,video_url,admin_status,posted_userid";
	$column_values="'".$date."','".$time."','".$day."','".$month."','".$year."','".$i_title."','".$i_city."','".$i_edit."','".$i_upload."','1','".$post_code."'";
...
alert('successfully inserted');
		window.location.href='lvideo.php';
		</script>";
		exit;
}
else
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Add Live Video News</div>
	...
	<a href="news_livevideoreports.php" style="color:white;">View Live Video reports </a></span>
	</div>
	...
	<!-- <input type="text" class="form-control" id="usr" name="i_title" placeholder="Please Enter Title" pattern="[a-zA-Z+ ]{3,100}" title="Please Enter Title" required>
	  	-->
<select class="form-control" id="usr" name="i_city" placeholder="Please Enter Title"  title="Please Enter Title" required>

        <option value="">--Select City --</option>

			<?php 
	$query_s1=mysql_query("select * from  city");
    ...
    ?>
	   ...
	   <option value="<?php echo($rg['SNO']);  ?>"> <?php echo($rg['City']); ?></option>
	   <?php } ?>
		</select>		
      </div>
		...
		<div class="form-group">
    <label for="usr" id="field_label">Enter Video URL</label>
	  <textarea class="form-control" name="i_upload" placeholder="Enter URL" title="Please Enter URL" ></textarea>
    <!--<input type="text"  class="form-control" name="i_upload" "file_extension|audio *|video *|image *|media_type" placeholder="Upload Image/Video" title="Please Upload Image/Video"/>	
	-->
	<br/>
