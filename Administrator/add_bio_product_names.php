...
$post_code=strtotime($asd);
	...
	$columns="vBioProductName,vStatus";
	$column_values="'".$i_title."','".$_POST['status']."'";
...
alert('successfully inserted');
		window.location.href='add_bio_product_names.php';
		</script>";
		exit;
}
else
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Add Bio Product Names</div>
	...
	<a href="bio_product_name_reports.php" style="color:white;">View reports </a></span>
	</div>
	...
	<div class="col-sm-12" id="b_content">
      ...
      <label for="usr" id="field_label">Bio Product Name<span style="color:red;"></span></label>
