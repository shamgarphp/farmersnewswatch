...
$filetype = "1";
	...
	$columns="category,created_date,created_time,created_day,created_month,created_year,news_title,content,file_type,file_content,admin_status,posted_userid";
	$column_values="'Fruit','".$date."','".$time."','".$day."','".$month."','".$year."','".$i_title."','".$i_edit."','".$filetype."','".$dyna."','1','".$post_code."'";
...
alert('successfully inserted');
		window.location.href='fruit.php';
		</script>";
		exit;
}
else
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Contract Farming --> Fruit Crops </div>
	...
	<a href="fruit_reports.php" style="color:white;">reports </a></span>
	</div>
