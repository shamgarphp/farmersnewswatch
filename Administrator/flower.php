...
$filetype = "1";
	...
	$column_values="'Flower','".$date."','".$time."','".$day."','".$month."','".$year."','".$i_title."','".$i_edit."','".$filetype."','".$dyna."','1','".$post_code."'";
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Contract Farming --> Flower Crops </div>
	...
	<a href="flower_reports.php" style="color:white;">reports </a></span>
	</div>
