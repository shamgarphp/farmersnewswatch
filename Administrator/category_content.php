...
$filetype = "1";
	...
	$columns="content_type,category,created_date,created_time,created_day,created_month,created_year,news_title,content,file_type,file_content,admin_status,posted_userid";
	$column_values="'".$_POST['content_type']."','".$_POST['category']."','".$date."','".$time."','".$day."','".$month."','".$year."','".$i_title."','".$i_edit."','".$filetype."','".$dyna."','1','".$post_code."'";
...
alert('successfully inserted');
		window.location.href='category_content.php';
		</script>";
		exit;
}
else
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Add Category Menus Content</div>
	...
	<a href="category_content_reports.php" style="color:white;">View reports </a></span>
	</div>
...
$tab_name="left_categories";
		...
		{
			?>
		<option value="<?php echo($row['iCategories_Id']); ?>"><?php echo($row['name']); ?></option>	
			<?php
...
?>
      ...
      <div class="form-group">
      <label for="usr" id="field_label">Content Type<span style="color:red;"></span></label>
      <select class="form-control" id="usr" name="content_type"  required>
	  <option value=""> -- Choose -- </option>
	  <option value="1"> Direct Content Display </option>
	  <option value="2"> Sub Content Wise Display </option>
