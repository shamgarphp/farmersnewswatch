...
<html lang="en">
<head>
<title>Bslate Education - Administrator Careers</title>
...
<div class="content" style="padding:0px;">
	...
	<div class="col-sm-12" id="edu_type_label" style="padding:10px 0px;"> Search Career Reports 
	</div>
...
<input type="submit" class="btn btn-success"  name="search" value="Search" style="width:100px;"> 
	...
	$table_export_data.=" <table class='table table-hover' style='border:1px solid lightgrey;'>
	  ...
	  <input type='checkbox' id='selectall'/>
		...
		<th style='font-weight:bold;'>User Query</th>
...
if($name!="")
{
$qry_sub=$qry_sub."name like '%".$name."%' and ";	
...
/*$whrs="where ".$thyz." and usertype='C'";	
	
	}
	else
	{
		$whrs="where year='".date('Y')."' and usertype='C'";	
	}*/
	...
	{		 
			 if(isset($_SESSION['search_results']))
					{
						$whrs="where ".$_SESSION['search_results']." and usertype='C'";
	...
	if($name!="")
		{
				...
				$query_s=mysql_query("select * from feedback where name='".$name."' and usertype='C'");
...
<a href='careers.php?view_edu&view=".base64_encode($row['sno'])."' onclick='javascript:if(confirm('Do you want Hostel Details')==true){return true}else{ return false;}' title='View'>
		<span class='glyphicon glyphicon-eye-open'></span></a>
<a href='careers.php?view_edu&remove=".base64_encode($row['sno'])."' onclick='javascript:if(confirm('Do you want remove')==true){return true}else{ return false;}' title='Remove'><span class='glyphicon glyphicon-trash'></span></a>
</td>
</tr>";
...
<div class="col-sm-3" id="edu_type_label" style="padding:10px 0px;margin-top:25px;">Career Reports

	<a href='careers.php?search_remove' class="btn btn-info btn-lg" style="padding:0px;">
...
<div class="col-sm-4" style="text-align:right;border:0px solid blue;margin-top:35px;"><b style="font-size:14px;color:#606060;">Export To :&emsp;&emsp;</b>
	<b><a href="exports.php?type=excel&filename=Career Reports" ><i class="fa fa-file-excel-o" style="font-size:20px;color:green;" title="Excel"></i></a></b> &nbsp;
	<b><a href="exports.php?type=word&filename=Career Reports" ><i class="fa fa-file-word-o"  style="font-size:20px;" title="Word"></i></a></b>  &nbsp;
	<b><a href="exports.php?type=pdf&filename=Career Reports" target="_blank" ><i class="fa fa-file-pdf-o" style="font-size:20px;color:red;" title="PDF"></i></a></b>
	</div>	
</div>	
...
<!------------- Pagination Code 2 ---------->
		...
		<?php 
				...
				if(isset($_SESSION['search_results']))
				{
					         ...
					         $sql = "SELECT * FROM feedback where ".$_SESSION['search_results']." and usertype='C'"; 	
				}
				else
				{
                       $sql = "SELECT * FROM feedback where  year='".date('Y')."' and usertype='C' "; 
				}
...
if(isset($_POST['remove_data']))
{
	...
	{
		$wher="where sno='".$item."' and usertype='C' ";
...
if(isset($_GET['remove']))
{
	...
	$table="feedback";
	$wher="where sno='".$datas."' and usertype='C' ";
...
<div class="modal fade" id="myModal1" role="dialog">
    ...
    <span class="modal-title" style="font-weight:bold;font-size:14px;color:#f8f8f8;;">View Career</span>
	...
	<?php 
	$update_tab="feedback";
	$conds="where sno='".$id_modal."' and usertype='C' ";
	...
	<div class="col-sm-3" style="color:;">
	<?php
	
	$qwe=$single['name'];
	
	$query_s=mysql_query("select * from feedback where name='".$qwe."' and usertype='C'");
