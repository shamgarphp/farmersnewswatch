...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Add Category</div>
	...
	<a href="category_reports.php" style="color:white;">View Category reports </a></span>
	</div>
	...
	<div class="col-sm-12" id="b_content">
      ...
      <label for="usr" id="field_label">Category Name<span style="color:red;"></span></label>
      <input type="text" class="form-control" id="usr" name="i_title" placeholder="Please Enter Category Name" pattern="[a-zA-Z+ ]{3,100}" title="Please Enter Title" required>
