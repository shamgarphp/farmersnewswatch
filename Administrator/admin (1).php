...
<div class="col-sm-8" >
  ...
  <div class="form-group">
    ...
    <input type="file"  onchange="readURL2(this);" class="form-control" name="image">
   
  </div>
  <div class="form-group">
    <b><label for="exampleInputEmail1"><b>Slider1<b></label>
    <input type="file" onchange="readURL2(this);" class="form-control" name="slider1">
   
  </div>
 <div class="form-group">
    <b><label for="exampleInputEmail1"><b>Slider2<b></label>
    <input type="file" onchange="readURL2(this);"  class="form-control" name="slider2">
   
  </div>
   <div class="form-group">
    <b><label for="exampleInputEmail1"><b>Slider3<b></label>
    <input type="file"  onchange="readURL2(this);" class="form-control" name="slider3">
...
$tablea="edu_user_institution";
  ...
  $colvala="'".$date."','".$time."','".$day."','".$month."','".$year."','".$mgmt_code."',$institut,'$pan_proof_imagename4','1'";
