...
&& in_array($extension, $allowedExts)) {
  if ($_FILES["i_upload"]["error"] > 0) {
   ...
   //   echo $pan_proof_imagename;
    if (file_exists("Admin_Promotions/" . $_FILES["i_upload"]["name"])) {
        $incre="1";
      ...
      move_uploaded_file($_FILES["i_upload"]["tmp_name"],
      "Admin_Promotions/" . $_FILES["i_upload"]["name"]);
...
$filetype = "1";
	...
	$table="promotions";
	$columns="created_date,created_time,created_day,created_month,created_year,priority,file_content,url";
	$column_values="'".$date."','".$time."','".$day."','".$month."','".$year."','".$_POST['priority']."','".$dyna."','".$_POST['url']."'";
	...
	//echo("insert into $table($columns) values($column_values)");
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Add Right Side Promotions</div>
	...
	<a href="promotions_reports.php" style="color:white;">View reports </a></span>
	</div>
	...
	<div class="col-sm-12" id="b_content">
      ...
      <label for="usr" id="field_label">Dsiplay Priority<span style="color:red;"></span></label>
      <select class="form-control" id="usr" name="priority"  required>
