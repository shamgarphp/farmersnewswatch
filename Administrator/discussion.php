...
&& in_array($extension, $allowedExts)) {
  if ($_FILES["i_upload"]["error"] > 0) {
   ...
   //   echo $pan_proof_imagename;
    if (file_exists("News_Uploads/studentdiscussion/" . $_FILES["i_upload"]["name"])) {
        $incre="1";
      $rn= $_FILES["i_upload"]["name"];
      $dyna=$incre.$rn;
      //echo $rrn;

      if(file_exists("News_Uploads/studentdiscussion/" . $dyna))
          {
      ...
      "News_Uploads/studentdiscussion/" . $dyna);
                       break;
                      }
      ...
      move_uploaded_file($_FILES["i_upload"]["tmp_name"],
      "News_Uploads/studentdiscussion/" . $_FILES["i_upload"]["name"]);
...
<div class="" style="padding:0px;">
	...
	<div class="col-sm-9" id="edu_type_label"> Add student discussion news</div>
	...
	<a href="news_stureports.php" style="color:white;">View Student reports </a></span>
	</div>
